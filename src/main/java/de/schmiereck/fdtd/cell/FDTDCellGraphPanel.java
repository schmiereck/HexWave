...
public class FDTDCellGraphPanel  extends JPanel {
    private final Holder<Integer> t;
    private final FDTDCellDto[] cellDtoArr;
    private final int maxFieldValue;

    public FDTDCellGraphPanel(final Holder<Integer> t, final FDTDCellDto[] cellDtoArr, final int maxFieldValue) {
        this.t = t;
        this.cellDtoArr = cellDtoArr;
    ...
    protected void paintComponent(final Graphics g) {
        ...
        final int amplitudeValueListSize = this.cellDtoArr.length;
