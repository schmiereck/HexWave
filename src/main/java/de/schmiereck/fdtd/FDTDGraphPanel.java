...
import de.schmiereck.moveField2D.MoveFieldDto;
import de.schmiereck.oscillation1.Holder;

import javax.swing.*;
import java.awt.*;

public class FDTDGraphPanel extends JPanel {
    final Holder<Integer> t;
    final double[] uRender;
    private final double maxFieldValue;

    public FDTDGraphPanel(Holder<Integer> t, double[] uRender, final double maxFieldValue) {
        this.t = t;
